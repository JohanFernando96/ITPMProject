...
const AwarenessReportGeneration = React.forwardRef((props, ref) => {
  //state
  ...
  const getAllAwareness = async () => {
    ...
    getPosts(response.data); // updating state using the reposone from get method
  };
...
export default AwarenessReportGeneration;
